...
struct TRRestRequest {
    var data: Data?
    var endpoint: String
    var headers: [String: String]?
    var method: TRRequester.HTTPMethod
}
...
class TRRequester {
    ...
    static func request(_ requestForm: TRRestRequest, completion: @escaping (RestResponse) -> Void) {
