...
struct V8RestRequest {
    var data: Data?
    var endpoint: String
    var headers: [String: String]?
    var method: V8Requester.HTTPMethod
}
...
class V8Requester {
    ...
    static func request(_ requestForm: V8RestRequest, completion: @escaping (RestResponse) -> Void) {
